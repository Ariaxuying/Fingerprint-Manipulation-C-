...
{
  double st_cond[3][3][46]={0};
  //TK4
    st_cond[0][0][0]=0;st_cond[0][1][0]=1;st_cond[0][2][0]=0;
    st_cond[1][0][0]=0;st_cond[1][1][0]=1;st_cond[1][2][0]=1;
    st_cond[2][0][0]=0;st_cond[2][1][0]=0;st_cond[2][2][0]=0;
    
    st_cond[0][0][1]=0;st_cond[0][1][1]=1;st_cond[0][2][1]=0;
    st_cond[1][0][1]=1;st_cond[1][1][1]=1;st_cond[1][2][1]=0;
    st_cond[2][0][1]=0;st_cond[2][1][1]=0;st_cond[2][2][1]=0;
    
    st_cond[0][0][2]=0;st_cond[0][1][2]=0;st_cond[0][2][2]=0;
    st_cond[1][0][2]=1;st_cond[1][1][2]=1;st_cond[1][2][2]=0;
    st_cond[2][0][2]=0;st_cond[2][1][2]=1;st_cond[2][2][2]=0;
    
    st_cond[0][0][3]=0;st_cond[0][1][3]=0;st_cond[0][2][3]=0;
    st_cond[1][0][3]=0;st_cond[1][1][3]=1;st_cond[1][2][3]=1;
    st_cond[2][0][3]=0;st_cond[2][1][3]=1;st_cond[2][2][3]=0;
 //STK4
...
void mark(double InputImage[ImageHeight][ImageWidth])
{
   double bi[3][3][16]={0};
    
    bi[0][0][0]=0;bi[0][1][0]=1;bi[0][2][0]=0;
    bi[1][0][0]=1;bi[1][1][0]=1;bi[1][2][0]=1;
    bi[2][0][0]=0;bi[2][1][0]=0;bi[2][2][0]=0;
    
    bi[0][0][1]=0;bi[0][1][1]=1;bi[0][2][1]=0;
    bi[1][0][1]=0;bi[1][1][1]=1;bi[1][2][1]=1;
    bi[2][0][1]=1;bi[2][1][1]=0;bi[2][2][1]=0;
    
    bi[0][0][2]=0;bi[0][1][2]=1;bi[0][2][2]=0;
    bi[1][0][2]=0;bi[1][1][2]=1;bi[1][2][2]=1;
    bi[2][0][2]=0;bi[2][1][2]=1;bi[2][2][2]=0;
    
    bi[0][0][3]=1;bi[0][1][3]=0;bi[0][2][3]=0;
    bi[1][0][3]=0;bi[1][1][3]=1;bi[1][2][3]=1;
    bi[2][0][3]=1;bi[2][1][3]=0;bi[2][2][3]=0;
    
    bi[0][0][4]=1;bi[0][1][4]=0;bi[0][2][4]=0;
    bi[1][0][4]=0;bi[1][1][4]=1;bi[1][2][4]=1;
    bi[2][0][4]=0;bi[2][1][4]=1;bi[2][2][4]=0;
    
    bi[0][0][5]=0;bi[0][1][5]=0;bi[0][2][5]=0;
    bi[1][0][5]=1;bi[1][1][5]=1;bi[1][2][5]=1;
    bi[2][0][5]=0;bi[2][1][5]=1;bi[2][2][5]=0;
    
    bi[0][0][6]=1;bi[0][1][6]=0;bi[0][2][6]=1;
    bi[1][0][6]=0;bi[1][1][6]=1;bi[1][2][6]=0;
    bi[2][0][6]=1;bi[2][1][6]=0;bi[2][2][6]=0;
    
    bi[0][0][7]=1;bi[0][1][7]=0;bi[0][2][7]=1;
    bi[1][0][7]=0;bi[1][1][7]=1;bi[1][2][7]=0;
    bi[2][0][7]=0;bi[2][1][7]=1;bi[2][2][7]=0;
    
    bi[0][0][8]=1;bi[0][1][8]=0;bi[0][2][8]=1;
    bi[1][0][8]=0;bi[1][1][8]=1;bi[1][2][8]=0;
    bi[2][0][8]=0;bi[2][1][8]=0;bi[2][2][8]=1;
    
    bi[0][0][9]=0;bi[0][1][9]=0;bi[0][2][9]=1;
    bi[1][0][9]=1;bi[1][1][9]=1;bi[1][2][9]=0;
    bi[2][0][9]=0;bi[2][1][9]=1;bi[2][2][9]=0;
    
    bi[0][0][10]=0;bi[0][1][10]=0;bi[0][2][10]=1;
    bi[1][0][10]=1;bi[1][1][10]=1;bi[1][2][10]=0;
    bi[2][0][10]=0;bi[2][1][10]=0;bi[2][2][10]=1;
    
    bi[0][0][11]=0;bi[0][1][11]=0;bi[0][2][11]=1;
    bi[1][0][11]=0;bi[1][1][11]=1;bi[1][2][11]=0;
    bi[2][0][11]=1;bi[2][1][11]=0;bi[2][2][11]=1;
    
    bi[0][0][12]=0;bi[0][1][12]=1;bi[0][2][12]=0;
    bi[1][0][12]=1;bi[1][1][12]=1;bi[1][2][12]=0;
    bi[2][0][12]=0;bi[2][1][12]=1;bi[2][2][12]=0;
    
    bi[0][0][13]=0;bi[0][1][13]=1;bi[0][2][13]=0;
    bi[1][0][13]=1;bi[1][1][13]=1;bi[1][2][13]=0;
    bi[2][0][13]=0;bi[2][1][13]=0;bi[2][2][13]=1;
    
    bi[0][0][14]=0;bi[0][1][14]=1;bi[0][2][14]=0;
    bi[1][0][14]=0;bi[1][1][14]=1;bi[1][2][14]=0;
    bi[2][0][14]=1;bi[2][1][14]=0;bi[2][2][14]=1;
    
    bi[0][0][15]=1;bi[0][1][15]=0;bi[0][2][15]=0;
    bi[1][0][15]=0;bi[1][1][15]=1;bi[1][2][15]=0;
    bi[2][0][15]=1;bi[2][1][15]=0;bi[2][2][15]=1;
            ...
            if(InputImage[i][j]==1)
            {
             ...
             for(int t=0;t<16;t++)
             {
               ...
               for(int m=-1;m<=1;m++)
               {
                for(int n=-1;n<=1;n++)
                {
                    if(InputImage[i+m][j+n]!=bi[m+1][n+1][t])
                    {
                        flag=1;
                    }
                }
    ...
    term[0][0][0]=0;term[0][1][0]=0;term[0][2][0]=0;
    term[1][0][0]=0;term[1][1][0]=1;term[1][2][0]=1;
    term[2][0][0]=0;term[2][1][0]=0;term[2][2][0]=0;
    
    term[0][0][1]=0;term[0][1][1]=0;term[0][2][1]=1;
    term[1][0][1]=0;term[1][1][1]=1;term[1][2][1]=0;
    term[2][0][1]=0;term[2][1][1]=0;term[2][2][1]=0;
    
    term[0][0][2]=0;term[0][1][2]=1;term[0][2][2]=0;
    term[1][0][2]=0;term[1][1][2]=1;term[1][2][2]=0;
    term[2][0][2]=0;term[2][1][2]=0;term[2][2][2]=0;
    
    term[0][0][3]=1;term[0][1][3]=0;term[0][2][3]=0;
    term[1][0][3]=0;term[1][1][3]=1;term[1][2][3]=0;
    term[2][0][3]=0;term[2][1][3]=0;term[2][2][3]=0;
    
    term[0][0][4]=0;term[0][1][4]=0;term[0][2][4]=0;
    term[1][0][4]=1;term[1][1][4]=1;term[1][2][4]=0;
    term[2][0][4]=0;term[2][1][4]=0;term[2][2][4]=0;
    
    term[0][0][5]=0;term[0][1][5]=0;term[0][2][5]=0;
    term[1][0][5]=0;term[1][1][5]=1;term[1][2][5]=0;
    term[2][0][5]=0;term[2][1][5]=1;term[2][2][5]=0;
    
    term[0][0][6]=0;term[0][1][6]=0;term[0][2][6]=0;
    term[1][0][6]=0;term[1][1][6]=1;term[1][2][6]=0;
    term[2][0][6]=0;term[2][1][6]=0;term[2][2][6]=1;
    
    term[0][0][7]=0;term[0][1][7]=0;term[0][2][7]=0;
    term[1][0][7]=0;term[1][1][7]=1;term[1][2][7]=0;
    term[2][0][7]=1;term[2][1][7]=0;term[2][2][7]=0;
            ...
            if(InputImage[i][j]==1)
            {
                ...
                for(int t=0;t<9;t++)
                {
                    ...
                    for(int m=-1;m<=1;m++)
                    {
                        for(int n=-1;n<=1;n++)
                        {
                            if(InputImage[i+m][j+n]!=term[m+1][n+1][t])
                            {
                                flag=1;
                            }
                        }
...
int main()
{
    ...
    unsigned char th1[ImageHeight][ImageWidth]={0};
    unsigned char th2[ImageHeight][ImageWidth]={0};
    unsigned char mi1[ImageHeight][ImageWidth][3]={0};
    unsigned char mi2[ImageHeight][ImageWidth][3]={0};
    ...
    for(int i=0;i<ImageHeight;i++)
    {
        for(int j=0;j<ImageWidth;j++)
        {
            th1[i][j]=InputImage1[i][j]*255;
            th2[i][j]=InputImage2[i][j]*255;
    ...
    for(int i=0;i<ImageHeight;i++)
    {
        for(int j=0;j<ImageWidth;j++)
        {
            ...
            if(InputImage1[i][j]==0)
            {
                mi1[i][j][0]=0;
                mi1[i][j][1]=0;
                mi1[i][j][2]=0;
            }
            if(InputImage1[i][j]==1)
            {
                mi1[i][j][0]=255;
                mi1[i][j][1]=255;
                mi1[i][j][2]=255;
    ...
    for(int i=0;i<ImageHeight;i++)
    {
        for(int j=0;j<ImageWidth;j++)
        {
                ...
                if(InputImage2[i][j]==0)
            {
                mi2[i][j][0]=0;
                mi2[i][j][1]=0;
                mi2[i][j][2]=0;
            }
            if(InputImage2[i][j]==1)
            {
                mi2[i][j][0]=255;
                mi2[i][j][1]=255;
                mi2[i][j][2]=255;
    ...
    GImageWrite(th1,"/Users/Aria/Documents/USC/569/hw2/hw2_images/th1.raw");
    GImageWrite(th2,"/Users/Aria/Documents/USC/569/hw2/hw2_images/th2.raw");
    ImageWrite(mi1,"/Users/Aria/Documents/USC/569/hw2/hw2_images/mi1.raw");
    ImageWrite(mi2,"/Users/Aria/Documents/USC/569/hw2/hw2_images/mi2.raw");
